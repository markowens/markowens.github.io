...
LABS=("BinaryTrees" "BreadthFirstSearch" "CVXPY_Intro" "FourierTransform" "GradientMethods" "InteriorPoint_Linear" "InteriorPoint_Quadratic" "LinkedLists" "MarkovChains" "NearestNeighbor" "PolynomialInterpolation" "Simplex" "Wavelets")
